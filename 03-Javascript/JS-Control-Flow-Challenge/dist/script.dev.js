...
switch (new Date().getDay()) {
  ...
  case 4:
    day = "1 more days until the weekend";
    break;

  case 5:
    day = "Tomorrow is the weekend";
    break;
...
console.log(day); // switch case for veg prices. Potatoes & carrots same price, broccoli, cabbage & asparagus different.
...
function getVegetable(event) {
  var vegetableHtml = event.target.value;
